<div class="partblock relative <?php echo implode(' ', array($layout, $background_color, $background_texture)); ?>" style="min-height:<?php echo $min_height; ?>px;">
  ...
  ?>
  <?php if ( $part_thumbnail_url != '' ): ?><div class="featured-image" style="background-image:url('<?php echo $part_thumbnail_url; ?>'); background-size:<?php echo $background_size; ?>; position:absolute; top:0; right:0; bottom:0; left:50%;"></div><?php endif; ?>
  <div class="container">
    <div class="row">
      <article class="part text-center col-sm-5 keyline-left">
