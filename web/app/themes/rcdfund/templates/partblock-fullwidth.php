<div class="partblock <?php echo implode(' ', array($layout, $background_color, $background_texture)); ?>">
  ...
  ?>
  <div class="container-fluid" style="background-position: center; background-image:url('<?php echo $part_thumbnail_url; ?>'); background-size:<?php echo $background_size; ?>; min-height:<?php echo $min_height; ?>px">
    <div class="row">
